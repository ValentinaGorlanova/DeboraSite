...
export function Sobre() {
  return (
    <>
      ...
      <h1 className={styles.sobre} id="sobremim">
        Sobre mim
      </h1>
      <h3 className={styles.info}>
        ...
        <br />
        <br />
        Apaixonada pela carreira que escolhi, acredito que todos estamos em constante evolução pessoal e que o melhor caminho para essa evolução é o
        autoconhecimento.
      </h3>
