  ...
  return (
    <>
      ...
      <div className={styles.insta} id="instagram">
        ...
        <h3 className={styles.text}>Aqui você pode saber um pouco mais sobre mim.</h3>
        {/* this carousel does not have the arrows to move around instead the use uses his moves to move the carousel */}
        <Carousel responsive={responsive} infinite className={styles.carousel} autoPlaySpeed={5000}>
          <div>
