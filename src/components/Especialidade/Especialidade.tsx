  ...
  return (
    <div className={styles.especialidade} id="especialidade">
      ...
      <div className={styles.left}>
        ...
        <div className={styles.title}>Especialidades atendidas</div>
        <div className={styles.des}>
          Psicoterapia Individual Adolescentes <br />
          Psicoterapia Individual Adultos
          <br />
          Psicoterapia de Casal <br /> Avaliação Psicológica para Cirurgias <br />
        ...
        <h3 className={styles.text}>Abordagens utilizadas</h3>
        ...
        <h5 className={styles.text1}>
          ...
          teorias cognitivas. A TCC entende a forma como o ser humano interpreta os acontecimentos como aquilo que nos afeta, e não os acontecimentos
          em si. <br />
          <br />
