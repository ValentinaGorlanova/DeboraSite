...
export function Consulta() {
  return (
    <>
      <link
        href="https://fonts.googleapis.com/css2?family=Barlow:wght@300;400;500&family=Epilogue:ital,wght@0,300;0,500;0,600;0,700;1,400&family=Montserrat:wght@300;400;500&family=Mukta:wght@300;400;500&family=Playfair+Display:wght@400;500&family=Readex+Pro:wght@300;400&display=swap"
        rel="stylesheet"
      />{" "}
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Barlow:wght@300;400;500&family=Epilogue:ital,wght@0,300;0,500;0,600;0,700;1,400&family=Mukta:wght@300;400;500&family=Playfair+Display&family=Readex+Pro:wght@300;400&display=swap"
        rel="stylesheet"
      ></link>
      <div className={styles.consulta}>
        <h1 className={styles.text}>Vamos agendar uma consulta?</h1>
        <form action="" method="post">
          ...
          <label htmlFor="presencial" className={styles.presencial}>
            presencial
          </label>
          <input type="radio" id="online" name="onlineCheck" value="online" className={styles.radio2} />
          <label htmlFor="online" className={styles.online}>
            Online
          </label>
        </form>
        <h3 className={styles.motivo}>Qual o motivo do contato</h3>
        <div className={styles.sintomas}>
          <input type="checkbox" className={styles.sinto1Box} />
          <h3 className={styles.sinto1}>Ansiedade</h3>
          <input type="checkbox" className={styles.sinto2Box} />
          <h3 className={styles.sinto2}>Depressão</h3>
          <input type="checkbox" className={styles.sinto3Box} />
          <h3 className={styles.sinto3}>Sindrome do Pânico</h3>
          <input type="checkbox" className={styles.sinto4Box} />
          <h3 className={styles.sinto4}>Alcoolismo</h3>
          <input type="checkbox" className={styles.sinto5Box} />
          <h3 className={styles.sinto5}>Dependência Química</h3>
          <input type="checkbox" className={styles.sinto6Box} />
          <h3 className={styles.sinto6}>Fobia Social</h3>
          <input type="checkbox" className={styles.sinto7Box} />
          <h3 className={styles.sinto7}>Autoconhecimento</h3>
          <input type="checkbox" className={styles.sinto8Box} />
          <h3 className={styles.sinto8}>TDAH e Transtornos de Aprendizagem</h3> <input type="checkbox" className={styles.sinto9Box} />
          <h3 className={styles.sinto9}>Outros:</h3>
        </div>
      ...
      <h3 className={styles.titleText}>
        “A quem possa interessar, o trabalho realizado pela Dra Debora é muito sério e com resultado. Se há dúvidas em procurar auxílio psicológico,
        apenas procure. Dra Debora, obrigada por tudo.”
      </h3>
