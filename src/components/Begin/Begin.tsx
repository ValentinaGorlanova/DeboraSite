  ...
  return (
    <>
      <div className={styles.inicial}>
        <div className={styles.left}>
          <h1 className={styles.text}>
            A terapia começa antes mesmo do terapeuta.{" "}
      ...
      <div className={styles.inicialText}>
        ...
        <h1 className={styles.textBanner}>Principais queixas e seus sintomas</h1>
        <h5 className={styles.ansiedade}>Ansiedade</h5>
        ...
        <h1 className={styles.depression}>Depressão</h1>
        ...
        <h4 className={styles.LutoText}>
          Alguns fatores podem influenciar a forma como cada pessoa irá vivenciar o seu luto, fatores que podem facilitar ou dificultar este processo,
          como a qualidade e o tipo de relação com o ente querido, a presença ou ausência de suporte social, as próprias características de
          personalidade do enlutado e, ainda, as circunstâncias que rodearam a perda, isto é, a forma como a morte ocorreu. O luto não elaborado
          (tratado) pode levar a depressão ou outros transtornos psicológicos.
        </h4>
        <h3 className={styles.abuso}>Abuso de Álcool e Drogas</h3>
      ...
      <div className={styles.textLeft}>
        ...
        <p className={styles.p2}>
          {" "}
          Se você passou por uma situação traumática (violência física, sexual e psicológica, acidente, doença, divórcio, luto)
        </p>
        <img src="/head.svg" alt="" className={styles.head3} />
        <p className={styles.p3}>Se você apresenta sintomas de doenças não diagnosticadas (alergias, enxaquecas, taquicardia, sudorese)</p>
        <img src="/head.svg" alt="" className={styles.head4} />
        <p className={styles.p4}>Se você precisa de válvulas de escape com frequência (medicações controladas, álcool/drogas, sexo, consumismo)</p>
        ...
        <p className={styles.p7}>
          Se você tem problemas nos seus relacionamentos pessoais, profissionais, sexuais (não consegue expor seus sentimentos, desconfiança, ciúme
          excessivo, isolamento
        </p>
      </div>
      <img src="/contagem1.png" className={styles.contagem} />
      <h3 className={styles.experience}>
        + de 15 anos <br />
        <div className={styles.efeito1}>de experiência</div>
      </h3>
      <h3 className={styles.paciente}>
        +300 pacientes <br />
        <div className={styles.efeito2}>atendidos</div>
      </h3>
      <h3 className={styles.horas}>
        +12.000 horas <br />
        <div className={styles.efeito3}>em consulta</div>
      </h3>
